...
## Reference material
This repository provides the code and working files for the exemplar project. It should be used alongside the guidance document: [IDI exemplar project: Guidance and training](https://www.sia.govt.nz/publications/IDI-Exemplar-Project-Guide). This contains a description of the project and guides a new researcher through the project steps. We have also included a range of tips to help researchers develop good practices in the IDI.

The original version of the exemplar project included a demonstration of SIA's tools for efficient IDI analysis. These have since been updated and have their own guidance material. You can find these here: [Accelerated Data Analysis & Pipeline Toolkit (ADAPT)](https://www.sia.govt.nz/publications/ADAPT-User-Guide).

## Versions
The exemplar can be downloaded as a zip file from GitHub. We also make a version of the exemplar available inside the data lab.
...
## Citation
Social Investment Agency 2026. IDI Exemplar Project – Guidance and training. Source code. https://github.com/nz-social-investment-agency/idi_exemplar_project
